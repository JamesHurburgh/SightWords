...
function loadSetList(){
	...
	for(var i = 0; i < selectedSightWordSetList.length; i++){
		...
		$("#setList").append("<div class='set' style='border: 4px solid #" + selectedSightWordSetList[i].colorHex + ";' collectionIndex='" + i + "' id='" + selectedSightWordSetList[i].setName + "_set'>" + selectedSightWordSetList[i].setName + "</div>");
